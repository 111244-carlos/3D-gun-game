...
export const MAPS = {
  compound: {
    ...
    prop: "crates", destructible: 0.5, vehicles: 3, ziplines: 0,
  ...
  warehouse: {
    ...
    prop: "crates", destructible: 0.7, vehicles: 1, ziplines: 0,
  ...
  dunes: {
    ...
    prop: "rocks", destructible: 0.2, vehicles: 2, ziplines: 0,
  ...
  forest: {
    ...
    prop: "trees", destructible: 0.6, vehicles: 2, ziplines: 3,
  ...
  snowfield: {
    ...
    prop: "rocks", destructible: 0.35, vehicles: 2, ziplines: 0,

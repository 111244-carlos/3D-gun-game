...
const weapons = [
  { name: "Vanguard AR", type: "Assault Rifle", cost: 0, ammo: 46, damage: 18, rpm: 690, range: 92, speed: 190, spread: 0.012, recoil: 0.28, color: 0xf0c22e, slot: 0, fire: "hitscan" },
  { name: "Longwatch", type: "Sniper", cost: 420, ammo: 8, damage: 125, rpm: 48, range: 210, speed: 280, spread: 0.00045, recoil: 1.1, color: 0x46534b, slot: 1, fire: "hitscan", zoom: true },
  { name: "Pebble Sling", type: "Slingshot", cost: 0, ammo: 26, damage: 26, rpm: 705, range: 55, speed: 95, spread: 0.018, recoil: 0.18, color: 0x8f6a42, slot: 2, fire: "arc" },
  { name: "Tri-Burst", type: "Burst Rifle", cost: 0, ammo: 45, damage: 17, rpm: 760, range: 88, speed: 195, spread: 0.01, recoil: 0.34, color: 0x2c3744, slot: 3, fire: "burst" },
  { name: "Frag Grenade", type: "Grenade", cost: 220, ammo: 9, damage: 82, rpm: 58, range: 42, speed: 55, spread: 0.006, recoil: 0.35, color: 0x394332, fire: "grenade" },
  { name: "Jump Pad", type: "Jump Pad", cost: 140, ammo: 3, damage: 0, rpm: 80, range: 18, speed: 0, spread: 0, recoil: 0.1, color: 0x279e90, fire: "pad" },
  { name: "Ranger Bow", type: "Bow", cost: 260, ammo: 20, damage: 54, rpm: 90, range: 85, speed: 110, spread: 0.006, recoil: 0.2, color: 0x6d5133, fire: "arrow" },
  { name: "Steel Crossbow", type: "Crossbow", cost: 330, ammo: 12, damage: 72, rpm: 72, range: 105, speed: 140, spread: 0.004, recoil: 0.3, color: 0x45494b, fire: "bolt" },
  { name: "Volt Lance", type: "Energy Rifle", cost: 520, ammo: Infinity, damage: 22, rpm: 620, range: 115, speed: 230, spread: 0.006, recoil: 0.17, color: 0x2e6d8f, fire: "energy" },
  { name: "Pulse Pistol", type: "Energy Pistol", cost: 0, ammo: Infinity, damage: 28, rpm: 360, range: 72, speed: 170, spread: 0.011, recoil: 0.32, color: 0x3979a0, fire: "energy" },
  { name: "Ember Hose", type: "Flamethrower", cost: 650, ammo: 130, damage: 7, rpm: 920, range: 22, speed: 50, spread: 0.045, recoil: 0.05, color: 0x8c3f24, fire: "flame" },
  { name: "Storm LMG", type: "Heavy Rifle", cost: 720, ammo: 115, damage: 19, rpm: 820, range: 98, speed: 190, spread: 0.019, recoil: 0.46, color: 0x424b3c, fire: "hitscan" },
  { name: "Rampage Minigun", type: "Minigun", cost: 900, ammo: 210, damage: 14, rpm: 1500, range: 95, speed: 205, spread: 0.03, recoil: 0.5, color: 0x3a3f33, fire: "hitscan" },
  { name: "Combat Uzi", type: "Uzi", cost: 150, ammo: 46, damage: 13, rpm: 900, range: 45, speed: 180, spread: 0.03, recoil: 0.22, color: 0x25272b, fire: "hitscan" },
  { name: "Rapid SMG", type: "SMG", cost: 260, ammo: 50, damage: 15, rpm: 780, range: 58, speed: 185, spread: 0.024, recoil: 0.24, color: 0x555f52, fire: "hitscan" },
